(function () {
    'use strict';
    var controllerName = 'LinkManagement_add_Ctrl';
    var mod = angular.module('NSOFT.STNOH.LinkManagement')
        .controller(controllerName, [
            ...
            'common.base',
            '$translate',
            LinkManagementAddController
        ]);

    function LinkManagementAddController(
        dataService,
        $q,
        $state,
        $scope,
        ...
        function init() {
            ...
            u4dmSvc.ui.sidePanel.setTitle($translate.instant('NSOFT_STNOH_LinkManagement.add'));
        ...
        function configureSidePanel() {
            vm.sidepanelConfig = {
                title: $translate.instant('NSOFT_STNOH_LinkManagement.add'),
                messages: [],
                actionButtons: [
                    {
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/LinkManagement-add.html',
                    controller: controllerName,
                    controllerAs: 'vm'
                }
            },
            data: {
                title: 'NSOFT_STNOH_LinkManagement.add'
            }
        };
